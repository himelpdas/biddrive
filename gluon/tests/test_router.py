...
router_doctest = dict(
    BASE = dict(
        applications = ['welcome', 'admin', 'myapp', 'app', 'bad!app'],
...
class TestRouter(unittest.TestCase):
    ...
    def test_router_doctest(self):
        ...
        self.assertEqual(filter_url('http://domain1.com/default/index/a%20bc'), "/app1/default/index ['a bc']")
        ...
        try:
            # 2.7+ only
            self.assertRaisesRegexp(HTTP, '', filter_url, 'http://domain.com/ctl/fcn/bad!arg')
