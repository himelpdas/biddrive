...
if not request.env.web2py_runtime_gae:
	...
	if platform.system() in ["Darwin", "Windows"]:
		...
		db = DAL('mysql://himdas:ekFh2E4t4VKF@mysql.biddrive.com/db_0') #http://goo.gl/g7cXti #PROBLEMS FIXED BY SETTING fake_migrate=True, erase inside /database folder, reload... Also clear cache on browser to remove previous login
else:
