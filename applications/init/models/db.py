...
if not request.env.web2py_runtime_gae:
	...
	if platform.system() in ["Darwin", "Windows"]:
		...
		db = DAL('mysql://himdas:ekFh2E4t4VKF@mysql.biddrive.com/db_0', check_reserved=['mysql']) #always check for reserved keywords in future possible DBs. #http://goo.gl/g7cXti #PROBLEMS FIXED by making new eb, erase inside /database folder, reload... Also clear cache on browser to remove previous login
else:
