...
def auction():
	...
	auction_request_info = dict(
		...
		answers = map(lambda each: each.capitalize().replace("_"," "),auction_request.questions),
		a_winning_offer_and_dealer=a_winning_offer_and_dealer,
		is_lease = is_lease,
...
def my_auctions():
	...
	for each_offer in my_offers:
		...
		each_offer_dict = {
			...
			'trim':each_offer.auction_request_offer.trim_name,
...
def winner():
	...
	return dict(
		...
		year=auction_request_offer.year, 
		trim = auction_request_offer.trim_name,
		make_name = auction_request_offer.make_name, 
		model_name = auction_request_offer.model_name, 
