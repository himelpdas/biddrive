...
def auction():
	...
	authorized_dealer = auth.has_membership(role='request_by_make_authorized_dealers_#%s'%auction_request_id) #will need authorized dealers but may have to move redirect function that controls this
