...
def index():
	...
	sort_types = map(lambda each_pair: each_pair[0], VEHICLE_STATES)
	if not show or not show in sort_types:
		show = "all"
	show_list = sorted( sort_types + ["all"])
