...
def handle_key_check():
	...
	if digit_pressed == '1':
		...
		if winner_code_exists:
			...
			resp.dial(twiml.Number(winning_dealer_phone_number, url = screen_for_machine_url, method="POST")) #convert init/voice/screen_for_machine.xml?model=... into screen_for_machine.xml?model=...
